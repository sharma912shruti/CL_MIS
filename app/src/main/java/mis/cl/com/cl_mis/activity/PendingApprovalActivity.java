...
public class PendingApprovalActivity extends BaseActivity {
    ...
    @BindView(R.id.pending_approval_recyclerview)
    RecyclerView mPendingApprovalRecyclerView;
    ...
    private void initialiseValue() {
        ...
        setHeader("Pending Approval", mToolbar);
    }

    private void setAdapter(){
        mList = new ArrayList<>();
        mAdapter = new ItemAdapter(this, mList);
        mPendingApprovalRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        mPendingApprovalRecyclerView.setAdapter(mAdapter);
    }
